...
# Add project root to sys.path for importing pipeline_v3 modules
PROJECT_ROOT = Path(__file__).resolve().parents[3]
if str(PROJECT_ROOT) not in sys.path:
    sys.path.append(str(PROJECT_ROOT))

from pipeline_v3.src.segmentation import assign_trips, apply_spatial_filter, haversine_vectorized
...
def run_segmentation_analysis():
    ...
    output_json_path = PROJECT_ROOT / "pipeline_v3" / "calibration_and_diagnostics" / "gps_survey_data_cleaning" / "resultados_segmentacion.json"
