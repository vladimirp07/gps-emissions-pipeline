...
Uso:
  ...
  python pipeline_v4/calibration_and_diagnostics/modal_classification/calibration/bayes/optimizar_matrices_optuna.py
...
CLASSIFIER_PATH = PROJECT_ROOT / "pipeline_v4" / "src" / "modal_classification.py"
...
def main():
    ...
    if not args.pkl.exists():
        ...
        print("    python pipeline_v4/calibration_and_diagnostics/modal_classification/calibration/bayes/generar_datos_entrenamiento.py")
        sys.exit(1)
